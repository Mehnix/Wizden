...
lootbox-trigger-examine-heat = There seems to be a bank of radiators protruding out from it.
lootbox-trigger-examine-pressure-high = A set of actuated plates look to be protecting parts from the external environment.
...
lootbox-trigger-examine-shock = There is an inset containing a mechanical heart pulsing arrhythmically.
...
lootbox-trigger-examine-topical = Some biomechanical element is bleeding an unknown red liquid that's preventing further function.
...
lootbox-trigger-examine-particle-engine = There is a protruding stasis container with a minuature singularity inside
lootbox-trigger-examine-particle-anomaly = A tiny anomaly core can be made out on its front. Perhaps it could be activated.
...
lootbox-trigger-examine-laser = The chain around the lock looks soft, a high intensity burst of heat might melt it.
...
lootbox-trigger-examine-stamp = There is a clearly printed laminate form attached demanding appropriate approval before unlocking is permitted.
